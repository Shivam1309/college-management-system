...
<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
  				  <li><a href="everyone2.php?tag=view_students">View Students</a></li>
  				</ul>
				</div>
				...
				<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
  				  <li><a href="everyone2.php?tag=view_teachers">View Teachers</a></li>
  				</ul>
				</div>
				...
				<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
  				  <li><a href="everyone2.php?tag=view_faculties">View Faculties</a></li>
  				</ul>
				</div>
				...
				<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
  				  ...
  				  <li><a href="everyone2.php?tag=view_subjects">View Subjects</a></li>
  				</ul>
				</div>
				...
				<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
  				  ...
  				  <li><a href="everyone2.php?tag=view_scores">View Score</a></li>
  				</ul>
				</div>
				...
				<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
  				  <li><a href="everyone2.php?tag=view_users">View Users</a></li>
  				</ul>
				</div>
				...
				<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
  				  ...
  				  <li><a href="everyone2.php?tag=view_artical">View Artical</a></li>
  				</ul>
				</div>
